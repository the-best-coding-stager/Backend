package com.example.demo.web.hateoas.listener;
...
import com.example.demo.web.hateoas.event.PaginatedResultsRetrievedEvent;
import com.example.demo.web.util.LinkUtil;
